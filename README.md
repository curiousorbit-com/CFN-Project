# COrbit::Cloudformation::Tester

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `corbit-cloudformation-tester.json`
2. Implement your resource handlers in `corbit_cloudformation_tester/handlers.py`
